...
```json
{
  ...
  "rerun_exit_code": 0,
  "rerun_stderr_tail": "",
  "rerun_stdout_tail": "Feature row materialization complete for feature-rows-season=2021:version=v1: {\"feature_version\": \"v1\", \"games_seen\": 2466, \"job\": \"feature-rows-v1-2021\", \"rows_upserted\": 2466, \"season\": 2021}\n"
}
```
